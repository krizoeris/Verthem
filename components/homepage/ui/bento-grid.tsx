...
export const BentoGridItem = ({
  ...
  return (
    <Tilt scale={scale} transitionSpeed={2500}>
      <div
        className={cn(
          "bento-grid row-span-1 rounded-2xl lg:min-h-[520px] group/bento hover:shadow-xl transition duration-200 shadow-input px-9 py-12 bg-white border-2 border-verthem-400 dark:bg-white/5 justify-between flex flex-col even:flex-col-reverse space-y-4",
          className,
        )}
      >
        {header}
